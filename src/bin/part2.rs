...
impl Stacks {
    ...
    fn apply_instruction(mut self, instruction: &CraneInstruction) -> Result<Self, CraneError> {
        ...
        // For CrateMover 9001, we keep the original order of the crates
        // (no need to reverse them like in part 1)

        // append items to the stack that we want to move to
...
mod tests {
    ...
    // runs `main()` and checks that the results are correct for part 2.
    #[test]
    ...
    fn test_part_2() {
        ...
        // The expected result for part 2 will be different from part 1
